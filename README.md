...
- [Data Cleaning Steps](#data-cleaning-steps)
  ...
  - [Step 5: Extracting Date info from `Died` column](#step-5-extracting-date-info-from-Died-column)
  - [Step 6: Extracting place and country infos from `Died` column](#step-6-extracting-place-and-country-infos-from-Died-column)
  - [Step 7: Creating `cleaned_athletes` table](#step-7-creating-cleaned_athletes-table)
- [Usage](#usage)
